...
use super::{
    handlers::{
        ...
        get_credential_balance, get_credential_models, get_endpoint_routing_config,
        get_global_proxy, get_load_balancing_mode, get_log_governance_config, get_model_mappings,
        get_prompt_filter_defaults, get_proxy_pool, get_runtime_governance_config,
...
pub fn create_admin_router(state: AdminState) -> Router {
    ...
    let authenticated = Router::new()
        ...
        .route(
            ...
            get(get_endpoint_routing_config).put(set_endpoint_routing_config),
        )
        .route(
